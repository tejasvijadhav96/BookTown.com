...
//	@JsonIgnore
	...
	public Book(Integer id, String title, float unitPrice) {
		super();
		this.id = id;
		this.title = title;
	...
	public Book(Integer id, String title, int stock, float unitPrice, Category category) {
		super();
		this.id = id;
		this.title = title;
		this.stock = stock;
	...
	public Book(Integer id, String title, int stock, float unitPrice, Category category, String imagePath) {
		super();
		this.id = id;
		this.title = title;
		this.stock = stock;
