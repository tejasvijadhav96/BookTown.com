...
public class AdminController {
	...
	@PostMapping("updatefarmer/{supplierid}")
	public ResponseEntity<?> UpdateSupplier(@PathVariable int farmerid, @RequestBody Supplier f) {
		System.out.println("RequestBody : " + f);
		Supplier farmer = f_service.getSupplierDetails(farmerid);
		System.out.println("old Supplier : " + farmer);
		if (farmer != null) {
			...
			service.UpdateSupplier(farmer);
			return new ResponseEntity<Supplier>(farmer, HttpStatus.OK);
		}
		return new ResponseEntity<Void>(HttpStatus.NOT_FOUND);
	}
